        ...
        <el-main class="login-container">
            <div class="login-card-container">
                <el-card class="login-card">
                    ...
                    <el-form label-position="top" :model="registerInfo" label-width="auto" style="max-width: 600px" class="login-form">
                        <el-form-item label="用户名" class="input-item">
                            <el-input :prefix-icon="User" v-model="registerInfo.userName" style="width: 100%" placeholder="用户名" class="input-no-border"/>
                        </el-form-item>
                        ...
                        <el-form-item label="确认密码" class="input-item">
                            <el-input :prefix-icon="Lock" class="input-no-border" v-model="registerInfo.confirmPassword" style="width: 100%" type="password" placeholder="密码" show-password/>
                        </el-form-item>
                        <el-form-item>
                            <el-button type="primary" size="large" round class="button">注册</el-button>
                        </el-form-item>
                    </el-form>
