...
!function(t, e) {
    CryptoJS = e();
    //exports 是 Node.js 中 CommonJS 模块化规范的核心对象，只有 Node 环境下 typeof exports 才是 object
    "object" == typeof exports ? 
    module.exports = exports = e() : 
    //define 是 AMD 模块化规范（如 RequireJS）的核心函数，define.amd 是 AMD 环境的标识 
    //这里的AMD指的是异步模块定义规范Asynchronous Module Definition
...
function getToken(player) {
    let key = CryptoJS.enc.Utf8.parse("FfVsZsTda94hJNKJfloaqyqMZFFimwl")
