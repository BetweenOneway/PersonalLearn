...
var findContentChildren = function(g, s) {
    ...
    for(var v of g)
    {
        for(var index=sIndex;index<s.length;index++)
        {
            if(v <= s[index])
            {
                sIndex = index+1;
